...
namespace Assessment2OOP
{
    internal class ThreeOrMore
    {
        ...
        public ThreeOrMore() 
        {
            ...
            {
                Console.WriteLine("There has been a problem creating the Three Or More game!" + exception.Message);
            }
        ...
        public int PlayThreeOrMoreAI()
        {
            ...
            while (true)
            {
                ...
                {
                    // Adds to list
                    die1.dieCurrentValue,
                    die2.dieCurrentValue,
                    die3.dieCurrentValue,
                    die4.dieCurrentValue,
                    die5.dieCurrentValue
                };
                ...
                {
                    // Adds to list
                    die6.dieCurrentValue,
                    die7.dieCurrentValue,
                    die8.dieCurrentValue,
                    die9.dieCurrentValue,
                    die10.dieCurrentValue
                };
